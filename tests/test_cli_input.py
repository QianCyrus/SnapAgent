...
def mock_prompt_session():
    ...
    with (
        patch("snapagent.cli.commands._PROMPT_SESSION", mock_session),
        patch("snapagent.cli.commands.patch_stdout"),
    ):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with (
        patch("snapagent.cli.commands.PromptSession") as mock_session_cls,
        patch("snapagent.cli.commands.FileHistory"),
