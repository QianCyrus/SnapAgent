...
class SkillsLoader:
    ...
    def _parse_snapagent_metadata(self, raw: str) -> dict:
    ...
    def _get_skill_meta(self, name: str) -> dict:
        """Get snapagent metadata for a skill (cached in frontmatter)."""
        meta = self.get_skill_metadata(name) or {}
        return self._parse_snapagent_metadata(meta.get("metadata", ""))
    ...
    def get_always_skills(self) -> list[str]:
        ...
        for s in self.list_skills(filter_unavailable=True):
            ...
            skill_meta = self._parse_snapagent_metadata(meta.get("metadata", ""))
